...
const productsData = [
    ...
    { id: 5, name: "The Villain 4", image: "images/imgi_21_The-Villain-4.png", price: 30.50, oldPrice: 31.50, quantity: 1, category: "New Arrivals" },
    { id: 6, name: "The Villain 3", image: "images/imgi_22_The-Villain-3.png", price: 30.50, oldPrice: 31.50, quantity: 1, category: "New Arrivals" },
    { id: 7, name: "The Villain 2", image: "images/imgi_23_The-Villain-2.png", price: 30.50, oldPrice: 31.50, quantity: 1, category: "New Arrivals" },
    { id: 8, name: "The Villain 1", image: "images/imgi_24_The-Villain-1.png", price: 30.50, oldPrice: 31.50, quantity: 1, category: "New Arrivals" }
];

// 2. COMPONENT GIAO DIỆN THẺ TRUYỆN (Giữ nguyên để HTML sạch sẽ)
    ...
    <div className="feat-card">
        ...
        <div className="feat-body">
            ...
            <div className="feat-meta">
                <span><i className="fa-regular fa-eye"></i> 5 Reviews</span>
                <a href="#" className="btn-arrow"><i className="fa-solid fa-arrow-right"></i></a>
            </div>
        </div>
    </div>
);
    ...
    <div className="product-card">
        ...
        <div className="prod-info">
            ...
            <div className="price-row">
                <span className="price-red">${product.price.toFixed(2)} {product.oldPrice && <del>${product.oldPrice.toFixed(2)}</del>}</span>
...
// 3. LỌC VÀ ĐỔ TRỰC TIẾP REACT VÀO HTML (Gộp bước cho ngắn)
const rootFeatured = document.getElementById('root-featured-products');
if (rootFeatured) {
    ReactDOM.createRoot(rootFeatured).render(
...
if (rootArrivals) {
    ReactDOM.createRoot(rootArrivals).render(
